	...
	_: {
		...
		routes: [
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/capture/_server.ts.js'))
			},
			{
				id: "/api/cron/daily",
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/cron/daily/_server.ts.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/push/subscribe/_server.ts.js'))
			},
			{
				id: "/debug",
				pattern: /^\/debug\/?$/,
